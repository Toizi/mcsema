...
linux_build_helper() {
  ...
  local file_list=( "cmake" "tools" "examples" "scripts" "tests" "docs" "OS" "mcsema" "generated" ".remill_commit_id" "CMakeLists.txt" "README.md" "CONTRIBUTING.md" ".gdbinit" "LICENSE" "ACKNOWLEDGEMENTS.md" ".gitignore" ".travis.yml" )
